...
| titleRender       | 自定义渲染节点的 title 内容径                                                                                              | (item: CheckCascaderItemEventData, flatted: boolean) => React.ReactNode | -                  |
...
| checkCascaded     | 支持 checkbox 级联（正反选）功能                                                                                           | true \| false                                                           | true               |
...
| onLoadChildren     | 异步请求更新数据   | (item: CheckCascaderItemEventData) => Promise\<CascaderItem[] \| void\> \| void | -                  | -      |
