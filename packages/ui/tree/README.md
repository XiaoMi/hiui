...
| expandIcon         | update                          | 字段： openIcon -> expandIcon，类型：string-> React.ReactNode                                                                                                                                                                 | 关键词命名                                                                                      |
| collapseIcon       | update                          | 字段： closeIcon -> collapseIcon，类型：string-> React.ReactNode                                                                                                                                                              | 语义化命名                                                                                      |
...
| placeholder        | feature                         | -                                                                                                                                                                                                                             | 强化支持编辑输入框自定义 placeholder                                                            |
