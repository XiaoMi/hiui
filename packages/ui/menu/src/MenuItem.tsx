...
export const MenuItem: React.FC<MenuItemProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`${prefixCls}-item__inner`}
        onClick={() => {
          if (children?.length) {
      ...
      >
        ...
        {/* 垂直菜单-弹出展开 */}
        {children?.length && placement === 'vertical' && expandedType === 'pop' && (
          <RightOutlined />
        )}
        {/* 水平菜单 */}
      ...
      {/* 垂直菜单-纵向展开 */}
      {children?.length && placement === 'vertical' && expanded && expandedType === 'default' && (
      ...
      {/* 垂直菜单-弹出展开 */}
      {children?.length && placement === 'vertical' && expanded && expandedType === 'pop' && (
        <PopperPortal
          visible={expanded}
