...
const _prefix = getPrefixCls('icon-heart-simple-outlined')

export const HeartSimpleOutlined = forwardRef<SVGSVGElement | null, IconProps>(
...
if (__DEV__) {
  HeartSimpleOutlined.displayName = 'HeartSimpleOutlined'
}
