...
const _prefix = getPrefixCls('icon-calendar-outlined')
...
export const CalendarOutlined = forwardRef<SVGSVGElement | null, IconProps>(
  ({ prefixCls = _prefix, className, children, size, style: styleProp, ...rest }, ref) => {
    ...
    return (
      <svg className={cls} ref={ref} role="icon" style={style} {...rest}   viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="13859"  ><path d="M836.266667 486.4H187.733333v334.933333a25.6 25.6 0 0 0 25.6 25.6h597.333334a25.6 25.6 0 0 0 25.6-25.6V486.4z m0-198.4a25.6 25.6 0 0 0-25.6-25.6h-110.933334v46.933333a38.4 38.4 0 1 1-76.8 0v-46.933333H401.066667v46.933333a38.4 38.4 0 1 1-76.8 0v-46.933333H213.333333a25.6 25.6 0 0 0-25.6 25.6v121.6h648.533334v-121.6z m76.8 533.333333a102.4 102.4 0 0 1-102.4 102.4H213.333333a102.4 102.4 0 0 1-102.4-102.4v-533.333333A102.4 102.4 0 0 1 213.333333 185.6h110.933334V138.666667a38.4 38.4 0 1 1 76.8 0v46.933333h221.866666V138.666667a38.4 38.4 0 1 1 76.8 0v46.933333H810.666667a102.4 102.4 0 0 1 102.4 102.4v533.333333z" p-id="13860"></path></svg>
    )
  }
)
