...
| 名称           | 说明                                                                           | 类型                                                                    | 参数                                                                                | 返回值                             |
| -------------- | ------------------------------------------------------------------------------ | ----------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ---------------------------------- |
<!--         | onExpand                                                                       | 节点被点击(展开/收起)时触发                                             | (expanded: boolean, expandIds: string[], expandedNode: TreeNode) => void            | expanded: 展开状态 <br/> expandIds | - | -->
| onCheck        | 点击节点多选框触发                                                             | (checked: boolean, checkedIds: string[], checkedNode: TreeNode) => void | -                                                                                   | -                                  |
| onSelect       | 点选节点时触发                                                                 | (selectedNode: TreeNode) => void                                        | selectedNode: 选中的节点                                                            | -                                  |
