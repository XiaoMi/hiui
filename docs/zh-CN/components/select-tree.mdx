...
| ---------------- | ----------------------------------------- | --------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ------ |
| data             | 展示数据                                  | DataItem []                                                                 | -                                                                                                          | -      |
| showCheckedMode  | 数据回显模式                              | string                                                                      | ALL: 所有被选中节点，不区分父子节点 <br/>PARENT: 当所有子节点被选中时将只保留父节点<br/>CHILD:仅显示子节点 | CHILD  |
...
| onChange         | 选中时触发                                | (checkedIds \| checkedId, checkedNodes \| checkedNode, currentNode) => void | -                                                                                                          | -      |
