...
| setListItemFieldsValue(ListItemInfo: Object)                               | 设置表单中From.List的指定项的值 [ListItemInfo](#ListItemInfo)         |
...
| 参数           | 说明                                                        | 类型   | 可选值 | 默认值 |
| -------------- | ----------------------------------------------------------- | ------ | ------ | ------ |
| name           |  对应 `Form.Item` 中的name，在列表项中的属性名称    | string   | -      | -      |
| listname       | 需要更新的列表名称               | string | -      | -      |
| row            |   对应 `Form.Item` 中的row，表示列表的第几行             | string | -      | -      |
| value          |   需要更新的值          | any | -      | -      |
...
| type       | 类型，常见有 `string` \|`number` \|`boolean` \| `email`。更多请参考[此处](https://github.com/yiminghe/async-validator#type) | 'any'                        |
