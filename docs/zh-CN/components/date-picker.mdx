...
| value       | 默认显示的日期                   | Date \| string \| number \| object \| undefined \| null | -                                                                                  | -      |
| defaultValue  | 默认显示的日期 <Badge type='feature' text='new' />                   | Date \| string \| number \| object \| undefined \| null | -                                                                                  | -      |
| min         | 可选择的最小日期                 | Date                                                    | -                                                                                  | -      |
| max         | 可选择的最大日期                 | Date                                                    | -                                                                                  | -      |
| disabled    | 是否禁用选择器                   | boolean                                                 | true \| false                                                                      | false  |
| showTime    | 是否在日期选择器中显示时间选择器 | boolean                                                 | true \| false                                                                      | false  |
| shortcuts   | 设置快捷面板                     | string[]                                                | '近一周', '近一月', '近三月', '近一年'                                             | -      |
| weekOffset  | 周起始<br/>默认周日做为第一列    | number                                                  | 0 \| 1                                                                             | 0      |
| placeholder | 设置输入框占位符                 | string \| string[]                                      | -                                                                                  | -      |
| format      | 格式化显示日期                   | string                                                  | -                                                                                  | -      |
| onChange    | 选择后的回调                     | (date: Date \| { start: Date, end: Date }) => void      | 普通时间选择返回 date 格式数据、范围选择返回对象{start:开始时间,end:结束时间}      |
