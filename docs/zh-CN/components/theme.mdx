...
**前往 [主题 Github](https://semver.org/lang/zh-CN/) **
...
<p><img src="<BASE_URL>/static/img/themes/classic/classic-theme-demo.jpg" width="90%" /></p>

- 当 `type = 'classic' apperance={color:'light'}` 时，为上下布局，顶部导航栏为浅色

<p><img src="<BASE_URL>/static/img/themes/classic/classic-theme-demo-light.jpg" width="90%" /></p>

- 当 `type = 'genuine' apperance={color:'dark'}` 时，为左右布局，侧边导航栏为深色

<p><img src="<BASE_URL>/static/img/themes/genuine/genuine-theme-demo.jpg" width="90%" /></p>

- 当 `type = 'genuine' apperance={color:'light'}` 时，为左右布局，侧边导航栏为浅色

<p><img src="<BASE_URL>/static/img/themes/genuine/genuine-theme-demo-light.jpg" width="90%" /></p>
