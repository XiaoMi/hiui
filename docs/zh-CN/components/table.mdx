...
| settingKeyPropName            | 自定义列设置时操作的 `key` 属性 (v3.9.0新增)                                                                          | string                                                    | -                                        | 'dataKey'   |
| hiddenColKeys                 | 隐藏列（受控） (v3.9.0新增)                                                                                          | string[]                                                  | -                                        | -          |
| onHiddenColKeysChange         | 列隐藏设置时回调 (v3.9.0新增)                                                                                        | (hiddenColKeys: string[]) => void                         | -                                         | -          |
