...
| disabledResizableColKeys   | 控制指定列禁用 Resizable                                                                                | string[]                                                   | -                                            | -      |
...
| fixedColumnTrigger        | 自定义冻结列触发展示行为                                                                                           | string                                                    | 'auto' \| 'always'                        | 'auto'     |
| highlightRowOnDoubleClick | 开启表格双击高亮行                                                                                                 | boolean                                                   | true \| false                             | true       |

## Event

| 属性名         | 描述               | 类型                                                                              | 可选值                                                                                  | 默认值                                                                                                |
| -------------- | ------------------ | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| onRow          | 行事件处理函数     | () => object                                                                      | -                                                                                       | -                                                                                                     |
