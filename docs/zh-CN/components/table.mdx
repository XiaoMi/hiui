...
import Demofilter from '../../demo/table/section-filter.jsx'
...
| onFilterDropdownVisibleChange | 自定义筛选下拉选项显示状态改变时的回调方法                                                                         | (filterDropdownVisible, ColumnItem) => void               | true \| false                             | false      |
...
| selectFilters           | 表头的筛选菜单, 更多配置请参考 [Select组件](https://infra.mioffice.cn/hiui/zh-CN/components/select)   | object                                                                                    | -                            | null   |
| sorter                  | 列排序函数                                                 | () => boolean                                                                                     | -                            | null   |
| defaultSortOrder        | 默认排序顺序                                               | ascend \| descend                                                                                 | -                            | null   |
| filterIcon              | 自定义 filter 图标                                         | ReactNode                                                                                         | -                            | null   |
| filterDropdown          | 自定义筛选菜单，此函数只负责渲染图层，需要自行编写各种交互 | (props: {ColumnItem, setFilterDropdownVisible}) => ReactNode                                      | -                            | null   |
