  ...
  render() {
    return (
      <div>
        ...
        <br/>
        <Progress percent={50} placement='inside' type='warn' height={20} size='large' content='错误'/>
        <br/>
        <Progress percent={50} placement='inside' type='error' height={20} size='large' content='警告'/>
        <br/>
