module.exports = {
  ...
  // collectCoverageFrom: [
  //   '<rootDir>/components/date-picker/**/*',
  //   '!<rootDir>/components/table/**/*',
  //   '!<rootDir>/components/nav-menu/**/*',
  //   '!<rootDir>/components/**/style/**/*',
  //   '!<rootDir>/components/**/__test__/**/*',
  ...
  testPathIgnorePatterns: ['/node_modules/', '/output/', '__mocks__', 'dekko', 'node'],
  ...
  transformIgnorePatterns: ['/output/', 'node_modules/[^/]+?/(?!(es|node_modules)/)'],
  verbose: true,
