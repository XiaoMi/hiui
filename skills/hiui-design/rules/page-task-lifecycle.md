...
| `UsageStats` | `PRIVACY.md`、workspace policy、preview readiness | usage 状态为 completed / skipped / unavailable / not_applicable 等可解释状态 | 统计失败不推翻页面交付，但必须披露下一步 | `OutputDeliverySummary` |
