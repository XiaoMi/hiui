# Host-integration Full-page Edit Archetype

This mode mounts the packaged shell runtime directly.

Keep `HostPageHeaderPortal`, `formScrollBody`, and `inlineEditFooter` inside the same `ProEditPage`.
