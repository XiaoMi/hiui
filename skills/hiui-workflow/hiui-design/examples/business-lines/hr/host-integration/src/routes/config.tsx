...
const RecruitmentOverviewPage = createLazyPage(
  () => import('../pages/hr/overview'),
  'RecruitmentOverviewPage'
)
const RecruitmentWaitingDetailPage = createLazyPage(
  () => import('../pages/hr/waiting-detail'),
  'RecruitmentWaitingDetailPage'
)
const RecruitmentInFlightDetailPage = createLazyPage(
  () => import('../pages/hr/inflight-detail'),
  'RecruitmentInFlightDetailPage'
)
      ...
      children: [
        {
          title: '招聘概览',
          path: 'overview',
          element: renderTypicalPage('招聘概览', <RecruitmentOverviewPage />, options),
        },
        {
          title: '待招详情',
          path: 'waiting-detail',
          element: renderTypicalPage('待招详情', <RecruitmentWaitingDetailPage />, options),
        },
        {
          title: '在途详情',
          path: 'inflight-detail',
          element: renderTypicalPage('在途详情', <RecruitmentInFlightDetailPage />, options),
        },
      ],
    },
  ]
