...
import Pagination from '../../es/pagination'
import Icon from '../../es/icon'
import '../../es/table/style/index.css'
import '../../es/checkbox/style/index.css'
import '../../es/pagination/style/index.css'
import '../../es/icon/style/index.css'
