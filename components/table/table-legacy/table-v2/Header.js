...
let HeaderCell = props => {
  ...
  return (
    <th
      ...
      onContextMenu={e => contextMenu(e, item.key)}
    >
      <div style={{ display: 'flex', alignItems: 'center' }}>
        ...
        &nbsp;
        {item.sorter && (
          <Sorter {...props} key={item.key} index={index} kname={item.key} />
        )}
        {item.serverSort && (
          <ServerSorter
            {...props}
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center' }}>
        ...
        {item.sorter && (
          <Sorter {...props} col={item} index={index} kname={item.key} />
        )}
...
export default class Header extends Component {
  render () {
    ...
    return <thead className={prifix('table-thead')}>{nodes}</thead>
  }
