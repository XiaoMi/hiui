...
class Preview extends Component {
  ...
  componentDidMount () {
    ...
    this.previewRef.current.addEventListener('wheel', this.handleMouseWheel, { passive: false })
  }
  componentWillUnmount () {
    this.previewRef.current.removeEventListener('wheel', this.handleMouseWheel, { passive: false })
  }
  onClose (e) {
    this.setState({
      style: {},
  ...
  render () {
    const { show, images, showArrow, showCount } = this.props
      ...
      >
        ...
        >
          ...
          <div className='hi-preview__close' onClick={this.onClose.bind(this)}>
            {/* <Icon name='close-circle' onClick={this.clickEvent.bind(this, 'close')} /> */}
          ...
          {
            showArrow && <div className='hi-preview__wrapper-arrow'>
              <Icon name='left' onClick={this.clickEvent.bind(this, 'prev')} />
              <Icon name='right' onClick={this.clickEvent.bind(this, 'next')} />
            </div>
          }
          {
            showCount && <div className='hi-preview__count'>
