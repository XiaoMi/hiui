...
<div>
<h1 align="center">
  欢迎来到HiUI V5，使用前请一定要先加入群聊！尊享内测福利：
</h1>


<br />
<h3>1. 群内有各种 V5 使用攻略和 FAQ 解答</h3>
<h3>2. 和群内大佬们在线交流，解决问题</h3>
<h3>3. 随时同步 V5 官方最新进展给各位</h3>

<img
  src="https://cdn.cnbj1.fds.api.mi-img.com/hiui-template/resources/yaoqing.png"
  width="360"
  style={{ position: "fixed", right: 48, top: 120, zIndex: 9999 }}
/>
...
# 全量安装（末尾一定要带上 `@feature`）
npm install @hi-ui/hiui@feature

# 单独组件包安装（末尾一定要带上 `@feature`）
npm install @hi-ui/组件名@feature
```
...
> v3 组件使用详见[官方文档](https://xiaomi.github.io/hiui/zh-CN/docs/quick-start)。
